...
var Actores = (function() {
  ...
  Actores.prototype.crear_actor = function(nombre) {
    ...
    var p = this.pilas.utilidades.combinar_propiedades(
...
var Animaciones = (function() {
  ...
  Animaciones.prototype.crear_animacion = function(
    actor,
    nombre_de_la_animacion,
    cuadros,
    velocidad
  ) {
...
var Automata = (function() {
  ...
  Automata.prototype.validar_que_existen_los_metodos_de_estado = function(
    nombre
  ) {
    ...
    if (!this.actor[nombre_del_metodo_iniciar]) {
      ...
      throw new Error(
        "Imposible usar el estado '" +
          nombre +
          "', porque no existe un m\u00E9todo llamado '" +
          nombre_del_metodo_iniciar +
          "'"
      );
    }
...
var Historia = (function() {
  ...
  Historia.prototype.serializar_escena = function(escena_actual) {
    this.fotos.push({
      ...
      actores: escena_actual.actores.map(function(e) {
        return e.serializar();
      })
    });
  };
  Historia.prototype.dibujar_puntos_de_las_posiciones_recorridas = function(
    graphics
  ) {
    var _this = this;
    this.fotos.map(function(historia) {
      historia.actores.map(function(entidad) {
        var _a = _this.pilas.utilidades.convertir_coordenada_de_pilas_a_phaser(
            entidad.x,
            entidad.y
          ),
          x = _a.x,
...
var Mensajes = (function() {
  ...
  Mensajes.prototype.atender_mensaje_definir_estados_de_depuracion = function(
    datos
  ) {
  ...
  Mensajes.prototype.atender_mensaje_actualizar_escena_desde_el_editor = function(
    datos
  ) {
  ...
  Mensajes.prototype.atender_mensaje_selecciona_actor_desde_el_editor = function(
    datos
  ) {
    this.pilas.modo.destacar_actor_por_id(datos.id);
  };
  Mensajes.prototype.atender_mensaje_actualizar_actor_desde_el_editor = function(
    datos
  ) {
  ...
  Mensajes.prototype.atender_mensaje_eliminar_actor_desde_el_editor = function(
    datos
  ) {
    this.pilas.modo.eliminar_actor_por_id(datos.id);
  };
  Mensajes.prototype.atender_mensaje_actualizar_proyecto_desde_el_editor = function(
    datos
  ) {
...
var Utilidades = (function() {
  ...
  Utilidades.prototype.acceso_incorrecto = function(v) {
    console.error(
      "No se puede definir esta propiedad (valor " +
        v +
  ...
  Utilidades.prototype.combinar_propiedades = function(
  ...
  Utilidades.prototype.obtener_distancia_entre = function(
    desde_x,
    desde_y,
    hasta_x,
    hasta_y
    ...
    return Math.sqrt(
      Math.pow(Math.abs(desde_x - hasta_x), 2) +
        Math.pow(Math.abs(desde_y - hasta_y), 2)
    );
  };
  return Utilidades;
})();
...
var Pilas = (function() {
  ...
  Pilas.prototype.obtener_actores_en = function(_x, _y) {
    var _a = this.utilidades.convertir_coordenada_de_pilas_a_phaser(_x, _y),
      x = _a.x,
      y = _a.y;
...
var ActorBase = (function() {
  ...
  ActorBase.prototype.pre_iniciar = function(propiedades) {
    ...
    this.sprite.on("pointerdown", function(cursor) {
      var posicion = _this.pilas.utilidades.convertir_coordenada_de_phaser_a_pilas(
        cursor.x,
        cursor.y
      );
  ...
  ActorBase.prototype.actualizar_sensores = function() {
    ...
    this.sensores.map(function(s) {
      ...
      s.colisiones = s.colisiones.filter(function(a) {
        return a._vivo;
      });
    });
  };
  ...
  Object.defineProperty(ActorBase.prototype, "x", {
    get: function() {
      var x = this.pilas.utilidades.convertir_coordenada_de_phaser_a_pilas(
        this.sprite.x,
        0
      ).x;
      return x;
    ...
    set: function(_x) {
      if (this.pilas.utilidades.es_animacion(_x)) {
        ...
        var x = this.pilas.utilidades.convertir_coordenada_de_pilas_a_phaser(
          _x,
          0
        ).x;
        this.sprite.x = x;
  ...
  Object.defineProperty(ActorBase.prototype, "y", {
    get: function() {
      var y = this.pilas.utilidades.convertir_coordenada_de_phaser_a_pilas(
        0,
        this.sprite.y
      ).y;
      return y;
    ...
    set: function(_y) {
      if (this.pilas.utilidades.es_animacion(_y)) {
        ...
        var y = this.pilas.utilidades.convertir_coordenada_de_pilas_a_phaser(
          0,
          _y
        ).y;
        this.sprite.y = y;
  ...
  ActorBase.prototype.agregar_sensor = function(ancho, alto, x, y) {
    var pos = this.pilas.utilidades.convertir_coordenada_de_pilas_a_phaser(
      x,
      y
    );
    var figura = this.pilas.modo.matter.add.rectangle(
      pos.x,
      pos.y,
      ancho,
      alto,
...
var nave = (function(_super) {
  ...
  nave.prototype.iniciar = function() {
    ...
    this.crear_animacion(
      "nave_avanzando",
      ["nave_avanza_1", "nave_avanza_2"],
      20
    );
    this.crear_animacion(
      "nave_girando_a_la_izquierda",
      ["nave_izquierda_1", "nave_izquierda_2"],
      20
    );
    this.crear_animacion(
      "nave_girando_a_la_derecha",
      ["nave_derecha_1", "nave_derecha_2"],
      20
    );
...
var EscenaBase = (function() {
  ...
  EscenaBase.prototype.obtener_nombre_para = function(nombre_propuesto) {
    var nombres_que_pueden_colisionar = this.actores
      ...
      .filter(function(e) {
        return e.startsWith(nombre_propuesto);
      });
    var contador = 1;
...
var Modo = (function(_super) {
  ...
  Modo.prototype.obtener_actor_por_id = function(id) {
    return this.pilas.modo.actores.filter(function(e) {
      return e.id === id;
    })[0];
  };
  Modo.prototype.actualizar_sprite_desde_datos = function(sprite, actor) {
    var _this = this;
    var coordenada = this.pilas.utilidades.convertir_coordenada_de_pilas_a_phaser(
      actor.x,
      actor.y
    );
  ...
  Modo.prototype.crear_figura_estatica_para = function(actor) {
    ...
    var angulo = this.pilas.utilidades.convertir_angulo_a_radianes(
      -actor.rotacion
    );
...
var ModoEditor = (function(_super) {
  ...
  ModoEditor.prototype.create = function(datos) {
    var _this = this;
    _super.prototype.create.call(
      this,
      datos,
      datos.proyecto.ancho,
      datos.proyecto.alto
    );
    this.actores = [];
    this.pilas = datos.pilas;
  ...
  ModoEditor.prototype.crear_manejadores_para_hacer_arrastrables_los_actores = function() {
    ...
    this.input.on("dragend", function(pointer, gameObject) {
      ...
      var posicion = escena.pilas.utilidades.convertir_coordenada_de_phaser_a_pilas(
        gameObject.x,
        gameObject.y
      );
      escena.pilas.mensajes.emitir_mensaje_al_editor(
  ...
  ModoEditor.prototype.crear_actores_desde_los_datos_de_la_escena = function(
    escena
  ) {
    var _this = this;
  ...
  ModoEditor.prototype.aplicar_atributos_de_actor_a_sprite = function(
    actor,
    sprite
  ) {
  ...
  ModoEditor.prototype.eliminar_actor_por_id = function(id) {
    var indice = this.actores.findIndex(function(e) {
      return e.id === id;
    });
...
var ModoEjecucion = (function(_super) {
    ...
    try {
      ...
      this.input.on("pointermove", function(cursor) {
        ...
        if (_this._escena_en_ejecucion) {
          try {
            _this._escena_en_ejecucion.cuando_mueve(
              posicion.x,
              posicion.y,
              cursor
            );
            ...
            console.error(e);
            _this.pilas.mensajes.emitir_excepcion_al_editor(
              e,
              "emitir cuando_mueve"
            );
            _this.pausar();
      ...
      this.input.keyboard.on("keyup", function(evento) {
        if (evento.key === "Escape") {
          _this.pilas.mensajes.emitir_mensaje_al_editor(
      ...
      this.input.on("pointerdown", function(cursor) {
        ...
        if (_this._escena_en_ejecucion) {
          try {
            _this._escena_en_ejecucion.cuando_hace_click(
              posicion.x,
              posicion.y,
              cursor
            );
  ...
  ModoEjecucion.prototype.obtener_escena_por_nombre = function(nombre) {
    var escenas_encontradas = this.proyecto.escenas.filter(function(e) {
  ...
  ModoEjecucion.prototype.obtener_referencias_a_clases = function() {
    var codigoDeExportacion = this.obtener_codigo_para_exportar_clases(
      this.codigo
    );
    var codigo_completo = this.codigo + codigoDeExportacion;
    return eval(codigo_completo);
  };
  ModoEjecucion.prototype.obtener_codigo_para_exportar_clases = function(
    codigo
  ) {
    ...
    if (codigo.match(re_creacion_de_clase)) {
      lista_de_clases = codigo.match(re_creacion_de_clase).map(function(e) {
        return e.match(re_solo_clase)[1];
      });
    }
    var diccionario = {};
  ...
  ModoEjecucion.prototype.dibujar_punto_de_control = function(
    graphics,
    _x,
    _y
  ) {
    graphics.fillStyle(0xffffff, 1);
    var _a = this.pilas.utilidades.convertir_coordenada_de_pilas_a_phaser(
        _x,
        _y
      ),
      x = _a.x,
...
var ModoPausa = (function(_super) {
  ...
  ModoPausa.prototype.crear_sprites_desde_historia = function(posicion) {
    ...
    this.sprites.map(function(sprite) {
      if (sprite.figura) {
        _this.pilas.Phaser.Physics.Matter.Matter.World.remove(
          _this.pilas.modo.matter.world.localWorld,
          sprite.figura
        );
      }
      if (sprite["texto"]) {
